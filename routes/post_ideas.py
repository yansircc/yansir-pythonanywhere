...
def post_ideas_endpoint():
    ...
    sys_prompt = data['summaried_trained_data']
    ...
    post_ideas_golem = Golem(openai_api_key, sys_prompt=sys_prompt, sys_prompt_prefix=sys_prompt_prefix, user_input_prefix=user_input_prefix, user_input_suffix=user_input_suffix)
