...
def serp_titles_golem_no_sse():
    ...
    sys_prompt = "As an SEO expert, guide me to craft better content. I'll provide Google query results. Analyze them and suggest improvements in the given format."
    user_input = f"Given my Google query {query} and its first {query_amount} results {serp_results} write down your insights in the following format: Search Intent: [identify the search intent in SERP and provide the corresponding reliability score. (informational, transactional, etc.)]\n Content Format: [suggest the most suitable content format (blog post, video, QA page, etc.)]\n Content type: [corresponding content type (listicle, roundup, etc.)]\n Recommended title: [provide a top-ranking page title]\n Description: [corresponding description]. For instance(the initial query: how to make money): Search Intent: Informational with 86% reliability\n Content Format: Blog post\n Content type: Listicle\n Recommended title: 10 Ways to Make Money Online\n Description: Here are 10 ways to make money online."
    user_input_suffix = "Ensure your response strictly follows the above format."
